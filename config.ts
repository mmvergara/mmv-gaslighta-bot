if (!process.env.NEXT_PUBLIC_CLIENT_APPLICATION_ID) throw new Error("APPLICATION_ID is not set");
...
if (!process.env.REGISTER_COMMANDS_KEY) throw new Error("REGISTER_COMMANDS_KEY is not set");
